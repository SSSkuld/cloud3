...
namespace cloud3
{
    public static class Uplord_file
    {
        ...
        /// </summary>
        public static void PutObject(string bucketName, string fileToUpload)
        {
            PutObjectFromFile(bucketName, fileToUpload);

            /*
            PutObjectFromFileWithTimeout(bucketName, fileToUpload);

            PutObjectFromString(bucketName);

            PutObjectWithDir(bucketName, fileToUpload);

            PutObjectWithMd5(bucketName, fileToUpload);

            PutObjectWithHeader(bucketName, fileToUpload);

            AsyncPutObject(bucketName, fileToUpload);
        ...
        public static void PutObjectFromFile(string bucketName, string fileToUpload)
        {
            ...
            string key =  fileToUpload.Substring(pos); // 获取上传文件名
...
//            Console.WriteLine(key);
        ...
        public static void PutObjectFromFileWithTimeout(string bucketName, string fileToUpload)
        {
        ...
        public static void PutObjectWithDir(string bucketName, string fileToUpload)
        {
        ...
        public static void PutObjectWithMd5(string bucketName, string fileToUpload)
        {
        ...
        public static void PutObjectWithHeader(string bucketName, string fileToUpload)
        {
        ...
        public static void AsyncPutObject(string bucketName, string fileToUpload)
        {
